...
if (isset($_POST['sprint_name'])) {
    ...
    foreach ($data as $row) {
        echo '<div class="col-lg-3 col-md-3 col-sm-3 col-6" style="padding-left: 0">'
            ...
            . '<li><a href="add_sprint.php?id=' . $row['sbl_id'] . '">เพิ่ม User Story</a></li>'
            . '<li><a href="action_issues.php?id=' . $row['sbl_id'] . '">ปัญหา</a></li>'
            .'<li><a href="summary.php?id=' . $row['id'] . '">ดู Burndown Chart</a></li>'
            . '<li><a href="delete_sprint.php?id=' . $row['sbl_id'] . '" onclick="return confirm(' . '\'Are you sure?\'' . ')">ลบ</a></li>'
            . '</ul>'
            . '</div>'
            . '<div style="background-color: #333;padding: 10px">'
            . '<a href="sprint_backlog.php?id=' . $row["sbl_id"] . '" class="link-sprint">' . $row["sbl_name"] . '</a>'
            . '</div> '
            . '</div> '
            . '</div> ';
    }
