            ...
            <div class="row" style="margin:0;px;padding: 40px;">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col-lg-offset-4 col-md-offset-4 col-sm-offset-4"
                    ...
                    <form role="form" class="form-horizontal" action="" method="post" enctype="multipart/form-data"
                        ...
                        <?php if (isset($success)) echo "<span style='margin-left: -10px;margin-bottom: 10px;color: green;font-family: sukhumvit;font-size: 1.3em'>" . $success . "<a href='login.php' style='font-weight: bold'>  คลิกเพื่อเข้าสู่ระบบ</a></span>"; ?>
                        <?php if (isset($warning)) echo "<span  style='margin-left: -10px;margin-bottom: 10px;color: orangered;font-family: sukhumvit;font-size: 1.3em'>" . $warning . "</span>"; ?>
                        <?php if (isset($err)) echo "<span style='margin-left: -10px;margin-bottom: 10px;color: red;font-family: sukhumvit;font-size: 1.3em'>" . $err . "</span>"; ?>
